...
local function resource_start()
   ...
   local panel_rect = dgsCreateRoundRect({
    ...
    --Profile IMG 
    -----------------------------------------
    dgs.profile_img = dgsCreateImage(0.027,0.097,0.12,0.13,dgsCreateRemoteImage(standart_profile_url),true,bank_main_panel)
    ...
    panel2 = dgsCreateWindow(0.35,0.26,0.3,0.15,language[language_section][2][1],true,tocolor(255,255,255),0,false,false,panel_rect,tocolor(255,255,255,255),false,true)
    ...
    dgs.close_panel2_btn = createButton(0.125,0.62,0.35,0.25,language[language_section][13][1],true,panel2)
